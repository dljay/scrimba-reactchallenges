...
type PlaceholderCharacterData = typeof noCharacter.noData
...
/* Challenge
    ...
    */
    ...
    // Replace noCharacter.noData with your CharacterData object (see challenge above).
    const [characterData, setCharacterData] = useState<
		CharacterData | PlaceholderCharacterData
	>({
    hat: true,
    shield: true,
    weapon: "staff",
    name:"DaZZi",
    attackOptions: ["beybladeX","powerJump","Kkus","Mari","ggomo","La"],
    stats: {hp: 97, mp: 99, strength: 99}
  })
    ...
    const functionToUse = setCharacterData
