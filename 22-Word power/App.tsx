...
export default function App() {
	const [wordsDataArray, setWordsDataArray] = React.useState<WordData[]>(wordsDataOne as WordData[])
	const [currentWord, setCurrentWord] = React.useState<WordData>(wordsDataArray[0])
