...
export default function App() {
    ...
    const [currentCalc, setCurrentCalc] = React.useState<CalcState>(INITIAL_STATE)
    ...
    function handleClick(event: React.MouseEvent<HTMLButtonElement>) {
        ...
        const numFromClick      = target.dataset.number
        const opFromClick       = target.dataset.operation
        const otherFromClick    = target.dataset.other
        ...
        const invalidEntry      = checkForInvalidEntry()
...
setCurrentCalc((prevVal) => ({
	...prevVal,
	currentNum: [...prevVal.currentNum, numFromClick]
  }))     
